...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color:rgb(188, 152, 255);">
        ...
        <div id="layoutSidenav">
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion" id="sidenavAccordion" style="background-color:rgb(188, 152, 255)">
                    ...
                    <div class="sb-sidenav-footer" style="background-color:rgb(203, 163, 255)">
