...
<div class="container">
                ...
                <div class="card-body">
                    <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
                        ...
                        <select class="form-control" name="albumid">
                            ...
                            <option value="<?php echo $data_album['albumid'] ?>"><?php echo
                             $data_album['namaalbum'] ?></option>
                        <?php } ?>
                        </select>
    ...
    <tr>
        ...
        <td>
            ...
            <!-- Modal Edit -->
            <div class="modal fade" id="edit<?php echo $data['fotoid']; ?>" tabindex="-1" aria-labelledby="editModalLabel<?php echo $data['fotoid']; ?>" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="editModalLabel<?php echo $data['fotoid']; ?>">Edit Data</h1>
            ...
            <!-- Modal Hapus -->
            <div class="modal fade" id="hapus<?php echo $data['albumid']; ?>" tabindex="-1" aria-labelledby="hapusModalLabel<?php echo $data['albumid']; ?>" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
